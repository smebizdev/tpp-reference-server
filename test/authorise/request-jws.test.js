...
describe('createJsonWebSignature', () => {
  ...
  describe('with signing algs ["HS256"]', () => {
    it('creates JWS', async () => {
      ...
      assert.equal(jws, 'eyJhbGciOiJIUzI1NiJ9.eyJleGFtcGxlIjoiY2xhaW1zIn0.713fdImuJuKedy8Lm5E2alESqRpT4cma1mXZVdX07k4');
    });
  });
